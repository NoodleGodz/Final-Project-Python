...
"       }")
        ...
        self.frame_cstmr_back.setFrameShape(QFrame.NoFrame)
        ...
        self.frame_icon_template.setFrameShape(QFrame.NoFrame)
...
"color: rgb(79, 159, 238);")
        ...
        self.frame_view_edit_profile.setFrameShape(QFrame.NoFrame)
        ...
        self.frame_btn_export_customer.setFrameShape(QFrame.NoFrame)
        self.frame_btn_export_customer.setFrameShadow(QFrame.Raised)
        self.layout_frame_btn_export_customer = QVBoxLayout(self.frame_btn_export_customer)
        self.layout_frame_btn_export_customer.setSpacing(0)
        self.layout_frame_btn_export_customer.setObjectName(u"layout_frame_btn_export_customer")
        self.layout_frame_btn_export_customer.setContentsMargins(0, 0, 0, 0)

        self.horizontalLayout_3.addWidget(self.frame_btn_export_customer)

        self.frame_btn_set_energy = QFrame(self.frame_12)
        self.frame_btn_set_energy.setObjectName(u"frame_btn_set_energy")
        self.frame_btn_set_energy.setFrameShape(QFrame.NoFrame)
        self.frame_btn_set_energy.setFrameShadow(QFrame.Raised)
        self.layout_frame_btn_set_energy = QVBoxLayout(self.frame_btn_set_energy)
        self.layout_frame_btn_set_energy.setSpacing(0)
        self.layout_frame_btn_set_energy.setObjectName(u"layout_frame_btn_set_energy")
        self.layout_frame_btn_set_energy.setContentsMargins(0, 0, 0, 0)

        self.horizontalLayout_3.addWidget(self.frame_btn_set_energy)
        ...
        self.frame_btn_toggle_contract.setFrameShape(QFrame.NoFrame)
        ...
        self.frame_btn_plot_user = QFrame(self.frame_12)
        self.frame_btn_plot_user.setObjectName(u"frame_btn_plot_user")
        self.frame_btn_plot_user.setFrameShape(QFrame.NoFrame)
        self.frame_btn_plot_user.setFrameShadow(QFrame.Raised)
        self.layout_frame_btn_plot_user = QVBoxLayout(self.frame_btn_plot_user)
        self.layout_frame_btn_plot_user.setObjectName(u"layout_frame_btn_plot_user")

        self.horizontalLayout_3.addWidget(self.frame_btn_plot_user)
